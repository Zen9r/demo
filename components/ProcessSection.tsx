          ...
          {processSteps.map((step, index) => (
            <div key={index} className="relative">
              ...
              {index < processSteps.length - 1 && (
                <div className="absolute left-8 top-16 w-0.5 h-16 bg-gray-300 transform -translate-x-1/2"></div>
              )}
              ...
              <div className="flex items-start gap-6">
                ...
                {/* Step Content */}
                <Card className="flex-1 bg-white hover:shadow-xl transition-all duration-300 border border-gray-100">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-2">تعاون مستمر</h4>
                <p className="text-gray-600">نعمل معك في كل مرحلة لضمان تحقيق رؤيتك</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">نلتزم بأعلى معايير الجودة في كل خطوة</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Clock className="w-8 h-8 text-purple-600" />
                </div>
                <h4 className="text-xl font-bold text-gray-900 mb-2">التزام بالمواعيد</h4>
                <p className="text-gray-600">نحترم المواعيد المتفق عليها وننجز المشروع في الوقت المحدد</p>
              </div>
            </div>
          </div>
        </div>
